...
class InstanceService:
    if __name__ == "__main__":
        ...
        dir_path = r'/project/controller/src/data/test-case-250000/'
        ...
        dir_path_data = r'/project/controller/src/data/test-case-250000/'
        filename_data = []
        ...
        if do_normalization:
            for x in range(0, filenum-1):
                ...
                try:
                    ...
                    print(filename[x])
                    with open('/project/controller/src/data/test-case-250000/' + filename[x], "r") as f:
                        jstring = f.read()
        ...
        if (filenum == 1):
            ...
            if controller_leitura_multiprocessada:
                ...
                comp = [poolNew.apply_async(cp.compGraph, args=(
