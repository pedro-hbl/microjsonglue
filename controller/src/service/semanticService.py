...
from utils import compSemantic as cs
    ...
    if __name__ == "__main__":
        ...
        if (filenum == 1):
            ...
            if controller_leitura_multiprocessada:
                ...
                comp = [poolNew.apply_async(cs.compSemanticGraph, args=(
                ...
                for x in range(0, filenum-1):
                    for y in range(x + 1, filenum-1):
                        ...
                        comp = cs.compSemanticGraph(graphs_dict[filename[x]], graphs_dict[filename[y]],
        ...
        output_message_body = {'Full compSemantic': full, 'matcherType': 'semantic', 'executionTime': end_exec_time}
        output_message_body_json = json.dumps(output_message_body)

        print('timeDelta: ' + str(timedelta(seconds=end - start)))

        print('Tamanho do objeto sem: ')
        print('1')
